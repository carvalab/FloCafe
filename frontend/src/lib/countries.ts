...
export const COUNTRIES: Country[] = [
  ...
  { code: 'GB', name: 'United Kingdom', currency: 'GBP', currencyCode: 'GBP ', timezone: 'Europe/London', dialCode: '+44', locale: 'en-GB', defaultLanguage: 'en', taxIdLabel: 'VAT', taxName: 'VAT' },
  { code: 'EU', name: 'European Union', currency: 'EUR', currencyCode: 'EUR ', timezone: 'Europe/Paris', dialCode: '+33', locale: 'fr-FR', defaultLanguage: 'fr', taxIdLabel: 'VAT', taxName: 'VAT' },
  { code: 'TH', name: 'Thailand', currency: 'THB', currencyCode: 'THB ', timezone: 'Asia/Bangkok', dialCode: '+66', locale: 'th-TH', defaultLanguage: 'th', taxIdLabel: 'Tax ID', taxName: 'VAT' },
  ...
  { code: 'PH', name: 'Philippines', currency: 'PHP', currencyCode: 'PHP ', timezone: 'Asia/Manila', dialCode: '+63', locale: 'en-PH', defaultLanguage: 'en', taxIdLabel: 'TIN', taxName: 'VAT' },
  { code: 'VN', name: 'Vietnam', currency: 'VND', currencyCode: 'VND ', timezone: 'Asia/Ho_Chi_Minh', dialCode: '+84', locale: 'vi-VN', defaultLanguage: 'vi', taxIdLabel: 'MST', taxName: 'VAT' },
  ...
  { code: 'AE', name: 'United Arab Emirates', currency: 'AED', currencyCode: 'AED ', timezone: 'Asia/Dubai', dialCode: '+971', locale: 'ar-AE', defaultLanguage: 'ar', taxIdLabel: 'TRN', taxName: 'VAT', documentTitle: 'Tax Invoice' },
  { code: 'SA', name: 'Saudi Arabia', currency: 'SAR', currencyCode: 'SAR ', timezone: 'Asia/Riyadh', dialCode: '+966', locale: 'ar-SA', defaultLanguage: 'ar', taxIdLabel: 'VAT', taxName: 'VAT', documentTitle: 'Tax Invoice' },
  ...
  { code: 'NG', name: 'Nigeria', currency: 'NGN', currencyCode: 'NGN ', timezone: 'Africa/Lagos', dialCode: '+234', locale: 'en-NG', defaultLanguage: 'en', taxIdLabel: 'TIN', taxName: 'VAT' },
  ...
  { code: 'PY', name: 'Paraguay', currency: 'PYG', currencyCode: 'PYG$', timezone: 'America/Asuncion', dialCode: '+595', locale: 'es-PY', defaultLanguage: 'es', taxIdLabel: 'RUC', taxName: 'IVA', documentTitle: 'Comprobante' },
  { code: 'JP', name: 'Japan', currency: 'JPY', currencyCode: 'JPY ', timezone: 'Asia/Tokyo', dialCode: '+81', locale: 'ja-JP', defaultLanguage: 'ja', taxIdLabel: '', taxName: 'VAT' },
  { code: 'KR', name: 'South Korea', currency: 'KRW', currencyCode: 'KRW ', timezone: 'Asia/Seoul', dialCode: '+82', locale: 'ko-KR', defaultLanguage: 'ko', taxIdLabel: 'BRN', taxName: 'VAT' },
  { code: 'CN', name: 'China', currency: 'CNY', currencyCode: 'CNY ', timezone: 'Asia/Shanghai', dialCode: '+86', locale: 'zh-CN', defaultLanguage: 'zh', taxIdLabel: 'USCC', taxName: 'VAT' },
  ...
  { code: 'PK', name: 'Pakistan', currency: 'PKR', currencyCode: 'PKR ', timezone: 'Asia/Karachi', dialCode: '+92', locale: 'en-PK', defaultLanguage: 'en', taxIdLabel: 'NTN', taxName: 'GST' },
  { code: 'BD', name: 'Bangladesh', currency: 'BDT', currencyCode: 'BDT ', timezone: 'Asia/Dhaka', dialCode: '+880', locale: 'bn-BD', defaultLanguage: 'en', taxIdLabel: 'TIN', taxName: 'VAT' },
  { code: 'LK', name: 'Sri Lanka', currency: 'LKR', currencyCode: 'LKR ', timezone: 'Asia/Colombo', dialCode: '+94', locale: 'en-LK', defaultLanguage: 'en', taxIdLabel: 'TIN', taxName: 'VAT' },
  { code: 'NP', name: 'Nepal', currency: 'NPR', currencyCode: 'NPR ', timezone: 'Asia/Kathmandu', dialCode: '+977', locale: 'ne-NP', defaultLanguage: 'en', taxIdLabel: 'TIN', taxName: 'VAT' },
  { code: 'EG', name: 'Egypt', currency: 'EGP', currencyCode: 'EGP ', timezone: 'Africa/Cairo', dialCode: '+20', locale: 'ar-EG', defaultLanguage: 'ar', taxIdLabel: 'TIN', taxName: 'VAT', documentTitle: 'Tax Invoice' },
